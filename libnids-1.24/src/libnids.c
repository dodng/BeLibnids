...
static void nids_syslog_return(int, int, struct ip *, void *);
...
static void nids_syslog_return(int type, int errnum, struct ip *iph, void *data)
{
	return;
}
